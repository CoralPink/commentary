 ...
 *
 * iPadOS may report `MacIntel` as the platform, so touch support is also checked to distinguish it from macOS.
 */
 ...
 *
 * This is intentionally a user-agent-based heuristic rather than feature detection.
 */
 ...
 *
 * iOS browsers, including Firefox and Chrome, use WebKit and therefore require the legacy implementation.
 * Safari on macOS is also included.
 */
