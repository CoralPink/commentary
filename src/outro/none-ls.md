...
```
<video width="1280" height="720" data-poster="img/grogu-thumbnail.avif">
...
![lua-fmt-before](img/lua-fmt-before.avif)

<kbd>Space</kbd><kbd>f</kbd> ってやってみると...。

![lua-fmt-after](img/lua-fmt-after.avif)
